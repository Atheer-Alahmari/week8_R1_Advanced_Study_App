...
class KotlinFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        list_RV = view.findViewById(R.id.rv_Kotlin)// Recycler View
        listKotlin= arrayListOf()
        titleED = view.findViewById(R.id.titel_ED)
        descED = view.findViewById(R.id.des_ED)
        ...
        addBtn.setOnClickListener {
            ...
            if (inputTitel.isNotEmpty() && inputDesc.isNotEmpty()) {
                dbhr.save_date("Kotlin", inputTitel, inputDesc)
    ...
    fun updateList() {
        listKotlin = dbhr.retrive("Kotlin")

        list_RV.adapter = RV_Adapter_Kotlin(this, listKotlin)
